...
public class LEDSubsystem extends SubsystemBase {
  ...
  public enum LEDMode {
    ...
    LAVE(-0.93), // fixed palette pattern, lavender
    ...
    SINELONLAVS(-0.73), // fixed palette pattern, sinelon, lava
    ...
    LIGHTCHASEDIM(0.01), // color 1, pattern light chase dimming
    HEARTBEATSLOW(0.03), // color 1, pattern heartbeat slow
    HEARTBEATMEDIUM(0.05), // color 1, pattern heartbeat medium
    HEARTBEATFAST(0.07), // color 1, pattern heartbeat fast
    BREATHSLOW(0.9), // color 1, pattern breath slow
    BREATHFAST(0.11), // color 1, pattern breath fast
    SHOT(0.13), // color 1, pattern shot
    STROBE(0.15), // color 1, pattern strobe
    END2ENDBLEND2BLACK(0.17), // color 2, pattern end to end blend to black
    LARSONSCANNER2(0.19), // color 2, pattern larson scanner
    LIGHTCHASEDIM2(0.21), // color 2, pattern light chase dimming
    HEARTBEATSLOW2(0.23), // color 2, pattern heartbeat slow
    HEARTBEATMEDIUM2(0.25), // color 2, pattern heartbeat medium
    HEARTBEATFAST2(0.27), // color 2, pattern heartbeat fast
    BREATHSLOW2(0.29), // color 2, pattern breath slow
    BREATHFAST2(0.31), // color 2, pattern breath fast
    SHOT2(0.33), // color 2, pattern shot
    STROBE2(0.35), // color 2, pattern strobe
    SPARKLECOLOR1(0.37), // color 1 and 2, pattern sparkle, color 1 on color 2
    SPARKLECOLOR2(0.39), // color 1 and 2, pattern sparkle, color 2 on color 1
    COLORGRADIENT(0.41), // color 1 and 2, pattern color gradient, color 1 and 2
    BEATSPERMINUTECOLOR1AND2(0.43), // color 1 and 2, pattern beats per minute, color 1 and 2
    END2ENDBLENDCOLOR1TO2(0.45), // color 1 and 2, pattern end to end blend, color 1 to 2
    END2ENDBLEND(0.47), // color 1 and 2, pattern end to end blend
    NOBLENDING(0.49), // color 1 and 2, pattern color 1 and color 2 no blending
    TWINKLESCOLOR1AND2(0.51), // color 1 and 2, pattern twinkles, color 1 and 2
    COLORWAVESCOLOR1AND2(0.53), // color 1 and 2, pattern color waves, color 1 and 2
    SINELONCOLOR1AND2(0.55), // color 1 and 2, pattern sinelon, color 1 and 2
    HOTPINK(0.57), // solid colors, hot pink
    DARKRED(0.59), // solid colors, dark red
    ...
    // OFF(.99), //off 
    // LIGHTBLUE(0.83),
    // FLASH(.99); //black and pink for auto 
